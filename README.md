...
The Greenfield project begins on Week 6 Day 3 (Wednesday) and ends on Week 7 Day 1 (Monday). During solo week you're expected to stay in contact with you group (via google hangouts, carrier pigeon, etc) and work 50% time (~5 hours per day). Your project must be feature __and__ code complete by the start of the day on Week 7 Day 1 (Monday).
...
You will not have very much time to work on the Greenfield Project together in person. You have two dedicated days for it (Wednesday & Thursday), then Friday we'll be doing a testing sprint, and Saturday is almost entirely the Hiring Day Assessment.
...
###Group Dynamics
Go out of your way to have a great time with your team. The teams that write the best code and get the most done are the ones who get along with each other and have something that excites them about the project (whether the project mission, the tech stack, the problem solving, the learning, getting more familiar with things that used to scare them, the product itself, etc.). 
Set up your team culture. Develop your inside jokes, the fun thing that you do each day to close out scrum, celebrate getting through the fights (you will have fights) with a smile at the end. The team will write more and better code if you do these things. 

Again, put effort into team dynamics. If you are not great at them yet, you will have no better time than now, while you are surrounded by a community of people who wants you to succeed and is also working on building up their own interpersonal skills. 
###Idea Selection
Your idea does not have to be original. The goal is not to build a new company, the goal is to build out a cool project you're excited about that gives you more experience solving problems in technology of your choice. If there's an idea you're excited about that someone else has already done, that's still a great idea for a project! 

If you're looking for inspiration, check out angelList, productHunt, and other sites. These tend to be filled with people who have the seed of an exciting idea but haven't had to deal with business constraints yet, and might just spark something in you.

###Technology Selection
We encourage the T-Shaped developer. You have enough familiarity with many technologies that you can comfortably talk about them, and pick them up in more depth rapidly depending on the needs of your job. This is the broad, flat part of the T. But you've also gone deep into one subject, gaining expertise in it to the point where you will likely be teaching your interviewer things they don't know (happens all the time). 

The reliable approach is to recognize that you already have the broad part of the T built out enough, and immediately specialize in one technology you know you want to get a job in (Backbone, Angular, React, Node.js, etc.), and spend the rest of the course and project time getting great at that. 

Another approach is to broaden the T a bit more, or remove some areas of fear that you have along the broad part of the T before specializing. 

The riskiest approach is to take on totally new technologies (like React). Only take on this approach if you are feeling quite confident and are willing to take on a risk.
...
issues. It provides a more powerful interface and can provide a kanban-board-like place to manage your 
...
People are more likely to judge your project from the README or the deployed site than they are to judge it based on the code itself. Make your README great!
...
- [ ] Configure automatic deployment of your master branch using Heroku (easiest), AWS, Azure, or other cloud services
...
<!--  ```javascript-->
<!--  $('body').append(-->
<!--    '<a href="http://[[ SCHOOL_NAME ]].com"> \-->
<!--    <img style="position: fixed; top: 0; right: 0; border: 0;" \-->
<!--    src="http://i.imgur.com/x86kKmF.png" \-->
<!--    alt="Built at [[ SCHOOL_NAME ]]"> \-->
<!--    </a>'-->
<!--  );-->
<!--  ```-->
...
## Group Assignments- Coming After Intro Lecture
